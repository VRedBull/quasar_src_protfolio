...
var cvEn = require('file-loader?name=[name].[ext]!../files/ABHAY_GEU23_RESUME.pdf')
...
export default {
  data () {
    return {
      ...
      rotateY: 0,
      rotateX: 0,
      about: 'I\'m a Software Engineer @LTIMindtree ' +
             'in Computer Science Engineering with passion for coding and design.' +
             'Lately I\'m focusing on ' +
             'Front-end web development and learning about the latest frameworks like Vue and Qasar' +
             '. When I\'m not coding, I prefer to go out, workout and travel.',
      getInTouch: `If you want to get in touch with me, feel free to 
             <a href="mailto:rathourabhay0305@gmail.com?Subject=Hello!">send me a mail</a>.`,
             techIUse: ['C', 'C++', 'Java', 'SQL', 'HTML', 'CSS', 'JavaScript', 'Vue.js', 'GIT', 'Windows', 'Powershell', 'Linux', 'Networking', 'Cloud', 'Virtualization', 'Python', 'Spring', 'Kafka'],
      langsISpeak: ['English', 'Hindi'],
      cv_langs: [
