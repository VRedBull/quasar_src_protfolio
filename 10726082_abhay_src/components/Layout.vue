...
export default {
  data () {
    return {
      ...
      contactInfo: [
        {text: 'rathourabhay0305@gmail.com', icon: 'mail', link: 'mailto:rathourabhay0305@gmail.com?Subject=Hello!'},
        /* {text: 'Abhay.github.io', icon: 'language', link: 'https://Abhay.github.io'}, */
        {text: '+91 8423998056', icon: 'phone'},
        {text: 'Abhay', icon: 'fa fa-skype', fa: 'sykpe'},
        {text: 'LinkedIn profile', icon: 'fa fa-linkedin', fa: 'linkedin', link: 'https://www.linkedin.com/in/abhay2603/'},
        {text: 'GitHub profile', icon: 'fa fa-github', fa: 'github', link: 'https://github.com/abhay2603'}
      ]
    }
  },
  methods: {
